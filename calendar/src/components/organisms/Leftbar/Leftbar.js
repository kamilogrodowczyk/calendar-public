...
import { Wrapper, Paragraph, AdminWrapper, CompanyWrapper, LeftbarButton, EmptyPlace } from './Leftbar.styles';
      ...
      <Wrapper isOpacity={isOpacity}>
        <AdminWrapper>
          <Title
            ...
            onClick={() => (client === 'admin' || client === 'pracownik' ? setSelectedCompany('') : null)}
            as="h2"
            isCenter
          >
            socialnet
